...
class Student(models.Model):
    ...
    photo = models.ImageField(upload_to='student_photos/', null=True, blank=True, help_text='Upload your photo for verification')
...
class GatePass(models.Model):
    ...
    photo = models.ImageField(upload_to='gatepass_photos/', null=True, blank=True, help_text='Upload your photo for gatepass verification')
    ...
    security_exit_date = models.DateField(null=True, blank=True, help_text='Date when student exited (security approval)')
    security_exit_time = models.TimeField(null=True, blank=True, help_text='Exact time when student exited (security approval)')
