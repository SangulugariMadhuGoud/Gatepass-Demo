...
# Path to locale message files (gatepass app)
LOCALE_PATHS = [BASE_DIR / 'gatepass' / 'locale']

# Cookie name for language preference (must match what set_language_view sets)
